...
public class webconnector{
    ...
    public void selectFromDropdownByVisibleText(String webElement, String text) throws Exception {
		Select dropdown = new Select(FindAnElement(webElement));
    ...
    public void selectMultipleItems(List<String> list, List<WebElement> elementList) throws Exception{
	...
	public void dragAndDrop(String draggable, String droppable) throws Exception {

		Actions action=new Actions(driver);
		action.dragAndDrop(FindAnElement(draggable), FindAnElement(droppable)).perform();
	}
    ...
    public void PerformActionOnElement(String WebElement, String Action, String Text) throws Exception {
		...
		case "ElementNotDisplayed":
			...
			break;
		case "SwitchToFrame":
			driver.switchTo().frame(FindAnElement(WebElement));
				break;
